...
Pico W BLE or simple web remote · dual-axis panel UX on top of SliderMC `CS motors 2`.
...
**Against Zeapon AXIS:** AXIS is the fastest bag-to-2-axis carbon slider (~USD 600–1200). JKSlider should not chase a motorized pan head — keep owning tactile 1-axis control; SliderMC `CS motors 2` is the path if a light pan face is needed.
