...
| File | Role |
|------|------|
| [`MC_MKS_client.py`](https://github.com/fablab-wue/SliderCtrl/blob/main/MC_MKS_client.py) | `MC_MKS_Client` — F5 motion, DE, ~5 Hz status |
| [`MC_MKS_config.py`](../MC_MKS_config.py) | Pins, `MM_PER_ROT`, soft limits, home/limits, accel map |
| [`SliderPins.example.py`](https://github.com/fablab-wue/SliderCtrl/blob/main/SliderPins.example.py) | `MC_MKS_config = { … }` overlay template |
