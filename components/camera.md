...
**SliderDMC:** Dragonframe shutter may also sit on the DMC Zero **GP9** (same OC idea, 2N7000 + GPIO protection ASCII). Firmware still sends MC `CT`. See [dmc/pins.md](../dmc/pins.md#camera-gp9--2n7000-level-shifter-5-v-and-gpio-protection).
