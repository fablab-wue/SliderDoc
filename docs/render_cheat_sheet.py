#!/usr/bin/env python3
"""Render manuals/JKSlider_Cheat_Sheet.html → manuals/JKSlider_Cheat_Sheet.pdf (A4)."""
...
HTML = ROOT / "manuals" / "JKSlider_Cheat_Sheet.html"
PDF = ROOT / "manuals" / "JKSlider_Cheat_Sheet.pdf"
