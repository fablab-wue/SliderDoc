...
![Velocity over time with cruise](img/sine_ramp_velocity.svg)

![Sine-ramp velocity with cruise in the middle](img/sine_ramp_velocity_cruise.svg)
...
![Velocity over position with cruise](img/sine_ramp_position.svg)
...
![Large stop_approach_hz](img/stop_approach_hz_large.svg)

![Small stop_approach_hz](img/stop_approach_hz_small.svg)

![Zero stop_approach_hz](img/stop_approach_hz_zero.svg)
...
![Sine vs linear ramp comparison](img/sine_vs_linear_ramp.svg)
