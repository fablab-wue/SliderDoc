...
Regenerate: `python tools/render_pico_pinout_JKSlider.py` → [`pico_pinout_mc.txt`](pico_pinout_mc.txt) + PNG.
...
Regenerate: `python tools/render_rp2040zero_pinout_SliderMC.py` → [`rp2040zero_pinout_mc.txt`](rp2040zero_pinout_mc.txt) + PNG.
