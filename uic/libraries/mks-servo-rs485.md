...
Component page / wiring: [../../components/mks-servoxx.md](../../components/mks-servoxx.md).
...
- You already have STEP/DIR + `DRV_ERROR` (use SERVO42C path in [../../components/integrated-drivers.md](../../components/integrated-drivers.md))  
