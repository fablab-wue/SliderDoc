...
Verbose `#…` status letters (OLED): [PROTOCOL — State letters](../../../../contract/protocol.md#state-letters) · [Verbose push](../../../../contract/protocol.md#verbose-push-3-hz-when-session-verbose1).
...
| [User Manual](../user-manual.md), cheat sheet (function) | **STOP**, **MOVE_L**, **OPTION** |
...
UART to SliderMC is on **GP16 (TX) / GP17 (RX)** on this UIC — wire **crossed** to the MC (UIC TX → MC RX, UIC RX → MC TX). See [Communication MC ↔ UIC](../../../../contract/link-and-handshake.md#communication-mc--uic). Regenerate: `python tools/render_pico_pinout_JKSlider.py`
