...
SliderMC planner & PIO: [MOTION.md](../../../../mc/motion.md) · command list: [PROTOCOL — Commands](../../../../contract/protocol.md#commands) · limits/homing keys: [CONFIG.md](../../../../mc/config.md) (Hard limits, Homing sections).
...
More detail for programmers: [../../../api/overview.md](../../../api/overview.md) (PIO section). Mechanics: [../../../../build/hardware-manual.md](../../../../build/hardware-manual.md). MC motion stack: [MOTION.md](../../../../mc/motion.md).
...
```text
python tools/sim_sine_ramp_fifo.py --accel 50
python tools/sim_sine_ramp_fifo.py --accel 100
python tools/sim_sine_ramp_fifo.py --accel 150
python tools/sim_sine_ramp_fifo.py --accel 200
python tools/sim_sine_ramp_fifo.py --accel 300
python tools/sim_sine_ramp_fifo.py --accel 400
```
...
![FIFO-word sine ramp 0→300 mm/s at 50 mm/s²](../../../../assets/img/sine_ramp_fifo_v300_a50.svg)

#### Peak accel 100 mm/s²

![FIFO-word sine ramp 0→300 mm/s at 100 mm/s²](../../../../assets/img/sine_ramp_fifo_v300_a100.svg)

#### Peak accel 150 mm/s²

![FIFO-word sine ramp 0→300 mm/s at 150 mm/s²](../../../../assets/img/sine_ramp_fifo_v300_a150.svg)

#### Peak accel 200 mm/s²

![FIFO-word sine ramp 0→300 mm/s at 200 mm/s²](../../../../assets/img/sine_ramp_fifo_v300_a200.svg)

#### Peak accel 300 mm/s²

![FIFO-word sine ramp 0→300 mm/s at 300 mm/s²](../../../../assets/img/sine_ramp_fifo_v300_a300.svg)

#### Peak accel 400 mm/s²

![FIFO-word sine ramp 0→300 mm/s at 400 mm/s²](../../../../assets/img/sine_ramp_fifo_v300_a400.svg)

Programmer detail and direction-change plot: [../../../api/overview.md](../../../api/overview.md) (Acceleration profile). Regenerate that plot with `python tools/render_dir_change_pause.py`.
