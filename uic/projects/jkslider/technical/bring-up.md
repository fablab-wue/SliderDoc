...
SliderMC flash & tasks: [BUILD.md](../../../../mc/build.md) · persistent keys: [CONFIG.md](../../../../mc/config.md) · pins: [PINS.md](../../../../mc/pins.md).
...
- SliderMC firmware from the sibling clone [`https://github.com/fablab-wue/SliderMC`](../../../../mc/build.md) ([BUILD.md](../../../../mc/build.md))
...
Work through the [Motor / slider checklist](#checklist--new-motor--slider-slidermc) below (axis on SliderMC), then set the panel options in `SliderPins.py` ([variants](panel.md#configuration-variants), pins).
...
These live on **SliderMC** (not UIC `UIC_config.py`). See [CONFIG.md](../../../../mc/config.md).
...
- [ ] Set `SliderPins.py` for your [variant](panel.md#configuration-variants) (`JKS_INPUT_MODE`, pins, joystick `None` if unused).
